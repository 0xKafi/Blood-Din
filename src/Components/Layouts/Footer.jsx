...
const Footer = () => {
    return (
        ...
        <div className='w-11/12 max-w-screen-xl mx-auto'>
            <footer className="footer flex justify-between bg-red-800 text-white py-10">
            <aside>
        ...
        <footer className="footer sm:footer-horizontal footer-center bg-red-900 text-white   p-4">
            <aside>
